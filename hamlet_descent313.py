...
# Define our pixelated font and gradient colors.
# Make sure "pixel_nes.otf" is in your working directory.
PIXEL_FONT_SIZE = 28
PIXEL_FONT = pygame.font.Font("Pixel_NES.ttf", PIXEL_FONT_SIZE)
# Define two tan colors for the gradient (top to bottom)
TAN_TOP = (145, 120, 80)
TAN_BOTTOM = (190, 170, 130)
...
def show_opening_scene(screen):
    ...
    while not opening_done:
        ...
        # Wrap text and render each line with gradient
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, speed):
        ...
        if os.path.exists(crow_sheet_path):
            self.frames = load_individual_frames("assets", "crow_fly", 1)
        if not self.frames:
